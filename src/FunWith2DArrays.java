...
public class FunWith2DArrays
{
    ...
    {
       String x = strArray [0][0];
       String y = strArray[0][strArray[0].length - 1];
       String z =strArray[strArray.length -1 ] [0];
       String a = strArray[strArray.length-1][strArray[0].length -1];
       System.out.print(x + "\n" + y + "\n" + z + "\n" + a + "\n");
    }
}